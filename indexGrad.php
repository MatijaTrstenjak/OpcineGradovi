...
<header class="header">
    ...
    <nav class="nav-items">
      ...
      <a class="nav-oznacen" href="indexGrad.php">Gradovi</a>
      <a href="indexBaza.php">Pretraživanje</a>
    </nav>
</header>

<div class="intro">
      <h1>Uspoređivanje gradova</h1>
...
<div class="container">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <?php header("Content-Type: text/html; charset=utf-8");
      include 'ispisDropdownGrad2.php';
      ?>
    </div>
  </div>
</div>
...
<script src="javaScriptGrad.js"></script>
</body>
</html>
