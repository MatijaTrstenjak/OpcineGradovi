function getData(broj) {
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            document.getElementById("gradonacelnik_Left").innerHTML = response['gradonacelnik'];
  ...
  function getData2(broj) {
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            document.getElementById("gradonacelnik_Right").innerHTML = response['gradonacelnik'];
